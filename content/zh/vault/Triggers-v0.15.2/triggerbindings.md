...
corresponding [`TriggerTemplate`](https://github.com/tektoncd/triggers/tree/release-v0.15.x/docs/.docs/triggertemplates.md) to populate with the extracted values. In other words, it *binds* payload fields to
...
You can specify multiple bindings within the `Trigger` definition in your [`EventListener`](/vault/Triggers-v0.15.2/eventlisteners/).
