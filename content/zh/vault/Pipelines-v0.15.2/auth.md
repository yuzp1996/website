...
above, see the
[authenticating-git-commands example](https://github.com/tektoncd/pipeline/tree/release-v0.15.x/examples/v1beta1/taskruns/authenticating-git-commands.yaml).
