...
[Why aren't PipelineResources in Beta?](/vault/Pipelines-v0.15.2/resources/#why-arent-pipelineresources-in-beta)._
...
a [`result`](https://github.com/tektoncd/pipeline/tree/release-v0.15.x/docs/docs/tasks.md#resultes)), and also that now the `Task` doesn't need to know anything
...
`Tasks` in your `Pipeline`, you can use [`Task` results](/vault/Pipelines-v0.15.2/tasks/#storing-execution-results) to
