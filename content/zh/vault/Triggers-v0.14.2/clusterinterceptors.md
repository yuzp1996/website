...
top-level `extensions` field to other [`Interceptors`](/vault/Triggers-v0.14.2/interceptors/) and `ClusterInterceptors` chained with it and the associated `TriggerBinding`.
