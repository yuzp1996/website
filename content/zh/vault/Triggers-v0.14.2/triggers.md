...
A `Trigger` specifies what happens when the [`EventListener`](/vault/Triggers-v0.14.2/eventlisteners/) detects an event. A `Trigger` specifies a [`TriggerTemplate`](/vault/Triggers-v0.14.2/triggertemplates/),
a [`TriggerBinding`](/vault/Triggers-v0.14.2/triggerbindings/), and optionally an [`Interceptor`](/vault/Triggers-v0.14.2/eventlisteners/#interceptors).
