...
[Why aren't PipelineResources in Beta?](/vault/Pipelines-v0.27.3/resources/#why-arent-pipelineresources-in-beta)._
...
a [`result`](/vault/Pipelines-v0.27.3/tasks/#emitting-results)), and also that now the `Task` doesn't need to know anything
...
`Tasks` in your `Pipeline`, you can use [`Task` results](/vault/Pipelines-v0.27.3/tasks/#emitting-results) to
