...
see [`authenticating-git-commands`](https://github.com/tektoncd/pipeline/tree/release-v0.19.x/examples/v1beta1/taskruns/authenticating-git-commands.yaml).
...
For example usage, see [`authenticating-git-commands`](https://github.com/tektoncd/pipeline/tree/release-v0.19.x/examples/v1beta1/taskruns/authenticating-git-commands.yaml).
...
[using a feature-flag: `require-git-ssh-secret-known-hosts`](/vault/Pipelines-v0.19.0/install/#customizing-the-pipelines-controller-behavior).
...
TaskRun's `Pod template` field](/vault/Pipelines-v0.19.0/taskruns/#specifying-a-pod-template).
...
1. Credentials must now be passed explicitly to Tasks either with [Workspaces](/vault/Pipelines-v0.19.0/workspaces/#using-workspaces-in-tasks),
