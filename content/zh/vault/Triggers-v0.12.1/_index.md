...
*  [`EventListener`](/vault/Triggers-v0.12.1/eventlisteners/) - listens for events at a specified port on your Kubernetes cluster.
   Specifies one or more `Triggers`.

*  [`Trigger`](/vault/Triggers-v0.12.1/triggers/) - specifies what happens when the `EventListener` detects an event. A `Trigger` specifies
   a `TriggerTemplate`, a `TriggerBinding`, and optionally, an `Interceptor`.

*  [`TriggerTemplate`](/vault/Triggers-v0.12.1/triggertemplates/) - specifies a template for the `TaskRun` or `PipelineRun` you want to
   instantiate and execute when EventListener detects an event.

*  [`TriggerBinding`](/vault/Triggers-v0.12.1/triggerbindings/) - specifies the fields in the event payload from which you want to extract
...
*  [`ClusterTriggerBinding`](/vault/Triggers-v0.12.1/clustertriggerbindings/) - a cluster-scoped version of the `TriggerBinding`,
...
*   [Setting Up Tekton Triggers](/vault/Triggers-v0.12.1/install/)
