...
Each container image that executes a `Step` in a [`Task`](/vault/Pipelines-v0.28.2/tasks/) must
...
However, if you're using the [`script` field](/vault/Pipelines-v0.28.2/tasks/#running-scripts-within-steps) to
