...
declare [TriggerBindings](/vault/Triggers-v0.11.2/triggerbindings/) to extract fields from events,
and apply them to [TriggerTemplates](/vault/Triggers-v0.11.2/triggertemplates/) in order to create
...
permissions on the Pipeline resources it needs to create. See a working example at [../examples/rbac.yaml](https://github.com/tektoncd/triggers/tree/release-v0.11.x/examples/rbac.yaml).
...
- `triggerRef` - (Optional) Reference to the [`Trigger`](/vault/Triggers-v0.11.2/triggers/).
...
check out the guide on [exposing EventListeners](/vault/Triggers-v0.11.2/exposing-eventlisteners/).
...
[config-logging.yaml](https://github.com/tektoncd/triggers/tree/release-v0.11.x/config/config-logging.yaml).
...
Check out a full example of using GitHub Interceptor in [examples/github](https://github.com/tektoncd/triggers/tree/release-v0.11.x/examples/github)
...
[CEL expressions](/vault/Triggers-v0.11.2/cel_expressions/).
...
## Response Timeout
Eventlistener sink timeout if EventListener isn't able to process the request within certain duration. The response timeout configuration is defined in [controller.yaml](https://github.com/tektoncd/triggers/tree/release-v0.11.x/config/controller.yaml).
...
where we need to specify the `secret` which contains `cert` and `key` files. See the full [example](https://github.com/tektoncd/triggers/tree/release-v0.11.x/examples/eventlistener-tls-connection/README.md) for more details.
