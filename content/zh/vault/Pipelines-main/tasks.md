...
- Optional:
  ...
  - [`resources`](#specifying-resources) - **alpha only** Specifies
    [`PipelineResources`](/vault/Pipelines-main/resources/) needed or created by your`Task`.
...
For an end-to-end example, see [the taskRun ignoring a step error](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/taskruns/ignore-step-error.yaml)
and [the pipelineRun ignoring a step error](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/pipelineruns/ignore-step-error.yaml).
...
a [`PipelineResources`](/vault/Pipelines-main/resources/#using-resources) entity.
...
and the [`Workspaces` in a `TaskRun`](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/taskruns/workspace.yaml) example YAML file.
...
The stored results can be used [at the `Task` level](/vault/Pipelines-main/pipelines/#configuring-execution-results-at-the-task-level)
or [at the `Pipeline` level](/vault/Pipelines-main/pipelines/#configuring-execution-results-at-the-pipeline-level).
...
The example Task/TaskRun above can be found as a [TaskRun example](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/taskruns/run-steps-as-non-root.yaml).
