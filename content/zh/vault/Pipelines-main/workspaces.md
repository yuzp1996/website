...
This is an alpha feature. The `enable-api-fields` feature flag [must be set to `"alpha"`](https://github.com/tektoncd/pipeline/tree/main/docs/install.md)
...
alpha feature and requires Pipelines to have [the "alpha" feature gate enabled](https://github.com/tektoncd/pipeline/tree/main/docs/install.md#alpha-features).
...
parameters](https://github.com/tektoncd/pipeline/tree/main/docs/install.md#customizing-basic-execution-parameters) section of the install doc.
...
For a more in-depth example, see [`Workspaces` in a `TaskRun`](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/taskruns/workspace.yaml).
...
[PodTemplate](/vault/Pipelines-main/pipelineruns/#specifying-a-pod-template) configured, the `NodeSelector` and `Tolerations` fields
...
[disable-affinity-assistant](https://github.com/tektoncd/pipeline/tree/main/docs/install.md#customizing-basic-execution-parameters) feature gate to `true`.
...
For examples of using other types of volume sources, see [Specifying `VolumeSources` in `Workspaces`](#specifying-volumesources-in-workspaces).
For a more in-depth example, see the [`Workspaces` in `PipelineRun`](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/pipelineruns/workspaces.yaml) YAML sample.
...
- [`Workspaces` in a `TaskRun`](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/taskruns/workspace.yaml)
- [`Workspaces` in a `PipelineRun`](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/pipelineruns/workspaces.yaml)
- [`Workspaces` from a volumeClaimTemplate in a `PipelineRun`](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/pipelineruns/workspace-from-volumeclaimtemplate.yaml)
