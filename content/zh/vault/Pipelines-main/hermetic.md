...
1. Make sure `enable-api-fields` is set to `"alpha"` in the `feature-flags` configmap, see [`install.md`](https://github.com/tektoncd/pipeline/tree/main/docs/install.md#customizing-the-pipelines-controller-behavior) for details
