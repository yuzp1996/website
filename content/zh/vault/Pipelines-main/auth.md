...
see [`authenticating-git-commands`](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/taskruns/authenticating-git-commands.yaml).
...
For example usage, see [`authenticating-git-commands`](https://github.com/tektoncd/pipeline/tree/main/examples/v1beta1/taskruns/authenticating-git-commands.yaml).
...
[using a feature-flag: `require-git-ssh-secret-known-hosts`](https://github.com/tektoncd/pipeline/tree/main/docs/install.md#customizing-the-pipelines-controller-behavior).
