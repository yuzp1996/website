...
You also have the option to define a global Pod template [in your Tekton config](https://github.com/tektoncd/pipeline/tree/release-v0.16.x/docs/install.md#customizing-basic-execution-parameters).
...
- [Specifying a Pod template for a `TaskRun`](/vault/Pipelines-v0.16.3/taskruns/#specifying-a-pod-template)
- [Specifying a Pod template for a `PipelineRun`](/vault/Pipelines-v0.16.3/pipelineruns/#specifying-a-pod-template)
