...
A `Trigger` specifies what happens when the [`EventListener`](/vault/Triggers-v0.16.1/eventlisteners/) detects an event. A `Trigger` specifies a [`TriggerTemplate`](/vault/Triggers-v0.16.1/triggertemplates/),
a [`TriggerBinding`](/vault/Triggers-v0.16.1/triggerbindings/), and optionally an [`Interceptor`](/vault/Triggers-v0.16.1/eventlisteners/#interceptors).
