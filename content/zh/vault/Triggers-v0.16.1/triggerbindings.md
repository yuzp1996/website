...
corresponding [`TriggerTemplate`](https://github.com/tektoncd/triggers/tree/release-v0.16.x/docs/.docs/triggertemplates.md) to populate with the extracted values. In other words, it *binds* payload fields to
...
You can specify multiple bindings within the `Trigger` definition in your [`EventListener`](/vault/Triggers-v0.16.1/eventlisteners/).
