...
For instructions on using variable substitutions see the relevant section of [the Tasks doc](/vault/Pipelines-v0.21.0/tasks/#using-variable-substitution).
...
Resource](/vault/Pipelines-v0.21.0/resources/#buildgcs-storage-resource) for more information.
