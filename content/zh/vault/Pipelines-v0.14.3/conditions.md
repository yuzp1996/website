...
check must specify a [`Step`](/vault/Pipelines-v0.14.3/tasks/#steps). The container image runs till completion. The container 
...
Conditions can declare input [`PipelineResources`](/vault/Pipelines-v0.14.3/resources/)  via the `resources` field to 
...
[variable substitution](/vault/Pipelines-v0.14.3/resources/#variable-substitution) and the `targetPath` field can be used
to [control where the resource is mounted](/vault/Pipelines-v0.14.3/resources/#controlling-where-resources-are-mounted)

## Labels and Annotations

[Labels](/vault/Pipelines-v0.14.3/labels/) and annotations defined as part of the `Condition` metadata will be automatically propagated to the `Pod`.
