...
Each container image that executes a `Step` in a [`Task`](/vault/Pipelines-v0.20.1/tasks/) must
...
However, if you're using the [`script` field](/vault/Pipelines-v0.20.1/tasks/#running-scripts-within-steps) to
