...
You also have the option to define a global Pod template [in your Tekton config](/vault/Pipelines-v0.20.1/install/#customizing-basic-execution-parameters).
...
- [Specifying a Pod template for a `TaskRun`](/vault/Pipelines-v0.20.1/taskruns/#specifying-a-pod-template)
- [Specifying a Pod template for a `PipelineRun`](/vault/Pipelines-v0.20.1/pipelineruns/#specifying-a-pod-template)
