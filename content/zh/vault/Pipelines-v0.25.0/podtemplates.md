...
You also have the option to define a global Pod template [in your Tekton config](/vault/Pipelines-v0.25.0/install/#customizing-basic-execution-parameters).
...
- [Specifying a Pod template for a `TaskRun`](/vault/Pipelines-v0.25.0/taskruns/#specifying-a-pod-template)
- [Specifying a Pod template for a `PipelineRun`](/vault/Pipelines-v0.25.0/pipelineruns/#specifying-a-pod-template)
