...
used as inputs to a [`Task`](/vault/Pipelines-v0.23.0/tasks/) and can be output by a `Task`.
...
> [the v1alpha1 to v1beta1 migration guide](/vault/Pipelines-v0.23.0/migrating-v1alpha1-to-v1beta1/#pipelineresources-and-catalog-tasks)
...
Resources can be used in [Tasks](/vault/Pipelines-v0.23.0/tasks/) and
[Conditions](/vault/Pipelines-v0.23.0/conditions/#resources).
...
at can be
[overridden with the `targetPath` field](/vault/Pipelines-v0.23.0/resources/#controlling-where-resources-are-mounted).
...
-   [Task](https://github.com/tektoncd/pipeline/tree/release-v0.23.x/examples/v1beta1/taskruns/optional-resources.yaml)
-   [Cluster Task](https://github.com/tektoncd/pipeline/tree/release-v0.23.x/examples/v1beta1/taskruns/optional-resources-with-clustertask.yaml)
-   [Condition](https://github.com/tektoncd/pipeline/tree/release-v0.23.x/examples/v1beta1/pipelineruns/conditional-pipelinerun-with-optional-resources.yaml)
-   [Pipeline](https://github.com/tektoncd/pipeline/tree/release-v0.23.x/examples/v1beta1/pipelineruns/demo-optional-resources.yaml)
...
[`example`](https://github.com/tektoncd/pipeline/tree/release-v0.23.x/cmd/pullrequest-init/example).
...
usually used as [a `Task` `output`](/vault/Pipelines-v0.23.0/tasks/#outputs) for `Tasks` that build
...
[variable substitution](/vault/Pipelines-v0.23.0/tasks/#variable-substitution):
