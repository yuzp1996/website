...
declare [TriggerBindings](/vault/Triggers-v0.7.0/triggerbindings/) to extract fields from events,
and apply them to [TriggerTemplates](/vault/Triggers-v0.7.0/triggertemplates/) in order to create
...
[`ClusterTriggerBindings`](/vault/Triggers-v0.7.0/clustertriggerbindings/), you'll need a
ServiceAccount with a
[ClusterRole instead](https://github.com/tektoncd/triggers/tree/v0.7.0/examples/role-resources/clustertriggerbinding-roles/clusterrole.yaml).
...
check out the guide on [exposing EventListeners](/vault/Triggers-v0.7.0/exposing-eventlisteners/).
...
[config-logging.yaml](https://github.com/tektoncd/triggers/tree/v0.7.0/config/config-logging.yaml).
...
[CEL expressions](/vault/Triggers-v0.7.0/cel_expressions/).
