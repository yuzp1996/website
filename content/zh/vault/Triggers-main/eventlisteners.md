...
`enable-api-fields`  [feature flag set to `alpha`](/vault/Triggers-main/install/#customizing-the-triggers-controller-behavior).
...
Use the Tekton [`create-ingress`](/vault/Triggers-main/getting-started/create-ingress.yaml) task to configure an `Ingress` object using self-signed certificates.
