...
should use a [`TaskRun`](/vault/Pipelines-v0.22.0/taskruns/).
...
- Optional:
  ...
  - [`workspaces`](#specifying-workspaces) - Specifies the physical volumes to use for the
    [`Workspaces`](/vault/Pipelines-v0.22.0/workspaces/) required by a custom task.
  - [`podTemplate`](#specifying-a-pod-template) - Specifies a [`Pod` template](/vault/Pipelines-v0.22.0/podtemplates/) to use
...
If the custom task supports it, you can provide [`Workspaces`](/vault/Pipelines-v0.22.0/workspaces/) to share data with the custom task.
...
If the custom task supports it, you can specify a [`Pod` template](/vault/Pipelines-v0.22.0/podtemplates/) configuration that the custom task will
