...
- Install from code
  ...
  You can clone and repository and install the Operator. You can find the instruction in [here](https://github.com/tektoncd/operator/tree/release-v0.50.x/DEVELOPMENT.md)
...
NOTE: `TektonResult` is an optional component added recently and is not installed through `TektonConfig` currently. You can find the installation steps in its [doc](/docs/operator/TektonResult/).
...
- [TektonDashboard](/docs/operator/TekonDashboard/)
- [TektonResult](/docs/operator/TektonResult/)
- [TektonAddon](/docs/operator/TektonAddon/)

To understand how Tekton Operator works, you can find the details [here](https://github.com/tektoncd/operator/tree/release-v0.50.x/docs/TektonOperator.md)
