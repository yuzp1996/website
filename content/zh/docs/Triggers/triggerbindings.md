...
corresponding [`TriggerTemplate`](https://github.com/tektoncd/triggers/tree/v0.17.0/docs/.docs/triggertemplates.md) to populate with the extracted values. In other words, it *binds* payload fields to
