...
should use a [`TaskRun`](/docs/pipelines/taskruns/).
...
- Optional:
  ...
  - [`podTemplate`](#specifying-a-pod-template) - Specifies a [`Pod` template](/docs/pipelines/podtemplates/) to use
...
If the custom task supports it, you can specify a [`Pod` template](/docs/pipelines/podtemplates/) configuration that the custom task will
