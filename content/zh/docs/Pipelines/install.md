...
1. Choose the version of Tekton Pipelines you want to install. You have the following options:
   ...
   * **[Nightly](https://github.com/tektoncd/pipeline/tree/release-v0.29.x/tekton/README.md#nightly-releases)** - may contain bugs,
...
the [explanation for the redesign in the PipelineResources doc](/docs/pipelines/resources/#why-arent-pipelineresources-in-beta)
...
**Note:** The `_example` key in the provided [config-defaults.yaml](https://github.com/tektoncd/pipeline/tree/release-v0.29.x/config/config-defaults.yaml)
...
- `disable-affinity-assistant` - set this flag to `true` to disable the [Affinity Assistant](/docs/pipelines/workspaces/#specifying-workspace-order-in-a-pipeline-and-affinity-assistants)
...
- `scope-when-expressions-to-task`: set this flag to "true" to scope `when` expressions to guard a `Task` only. Set it
  ...
  `Task` execution using `when` expressions](/docs/pipelines/pipelines/#guard-task-execution-using-whenexpressions).
...
| [`Runs` and `Custom Tasks`](/docs/pipelines/runs/)                                          | [TEP-0002](https://github.com/tektoncd/community/blob/main/teps/0002-custom-tasks.md)                       | [v0.19.0](https://github.com/tektoncd/pipeline/releases/tag/v0.19.0) | `enable-custom-tasks`       |
| [Isolated `Step` & `Sidecar` `Workspaces`](/docs/pipelines/workspaces/#isolated-workspaces) | [TEP-0029](https://github.com/tektoncd/community/blob/main/teps/0029-step-workspaces.md)                    | [v0.24.0](https://github.com/tektoncd/pipeline/releases/tag/v0.24.0) |                             |
...
| [Graceful Termination](/docs/pipelines/pipelineruns/#gracefully-cancelling-a-pipelinerun)   | [TEP-0058](https://github.com/tektoncd/community/blob/main/teps/0058-graceful-pipeline-run-termination.md)  | [v0.25.0](https://github.com/tektoncd/pipeline/releases/tag/v0.25.0) |                             |
| [`PipelineRun` Timeouts](/docs/pipelines/pipelineruns/#configuring-a-failure-timeout)       | [TEP-0046](https://github.com/tektoncd/community/blob/main/teps/0046-finallytask-execution-post-timeout.md) | [v0.25.0](https://github.com/tektoncd/pipeline/releases/tag/v0.25.0) |                             |
| [Implicit `Parameters`](/docs/pipelines/taskruns/#implicit-parameters)                      | [TEP-0023](https://github.com/tektoncd/community/blob/main/teps/0023-implicit-mapping.md)                   | [v0.28.0](https://github.com/tektoncd/pipeline/releases/tag/v0.28.0) |                             |
| [Windows Scrips](/docs/pipelines/tasks/#windows-scripts)                                    | [TEP-0057](https://github.com/tektoncd/community/blob/main/teps/0057-windows-support.md)                    | [v0.28.0](https://github.com/tektoncd/pipeline/releases/tag/v0.28.0) |                             |
...
The default configuration is defined in [webhook-hpa.yaml](https://github.com/tektoncd/pipeline/tree/release-v0.29.x/config/webhook-hpa.yaml) which can be customized
...
To get started with Tekton Pipelines, see the [Tekton Pipelines Tutorial](https://github.com/tektoncd/pipeline/tree/release-v0.29.x/docs/tutorial.md) and take a look at our [examples](https://github.com/tektoncd/pipeline/tree/main/examples).
