...
- Optional:
  ...
  - [`resources`](#specifying-resources) - **alpha only** Specifies
    [`PipelineResources`](/docs/pipelines/resources/) needed or created by your`Task`.
...
* `/tekton` - This directory is used for Tekton specific functionality:
    ...
    * There are other subfolders which are [implementation details of Tekton](https://github.com/tektoncd/pipeline/tree/release-v0.29.x/docs/developers/README.md#reserved-directories)
...
For an end-to-end example, see [the taskRun ignoring a step error](https://github.com/tektoncd/pipeline/tree/release-v0.29.x/examples/v1beta1/taskruns/ignore-step-error.yaml)
and [the pipelineRun ignoring a step error](https://github.com/tektoncd/pipeline/tree/release-v0.29.x/examples/v1beta1/pipelineruns/ignore-step-error.yaml).
...
a [`PipelineResources`](/docs/pipelines/resources/#using-resources) entity.
...
and the [`Workspaces` in a `TaskRun`](https://github.com/tektoncd/pipeline/tree/release-v0.29.x/examples/v1beta1/taskruns/workspace.yaml) example YAML file.
...
The stored results can be used [at the `Task` level](/docs/pipelines/pipelines/#configuring-execution-results-at-the-task-level)
or [at the `Pipeline` level](/docs/pipelines/pipelines/#configuring-execution-results-at-the-pipeline-level).
...
The example Task/TaskRun above can be found as a [TaskRun example](https://github.com/tektoncd/pipeline/tree/release-v0.29.x/examples/v1beta1/taskruns/run-steps-as-non-root.yaml).
